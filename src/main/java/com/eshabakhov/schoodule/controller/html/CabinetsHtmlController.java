 ...
 */
@Controller
@RequestMapping("/schools/{school}/buildings/{building}/cabinets")
...
public class CabinetsHtmlController {
    ...
    public ModelAndView list(
        ...
        var condition = CabinetsHtmlController.CABINET.IS_DELETED.eq(false)
            .and(CabinetsHtmlController.CABINET.BUILDING_ID.eq(building));
    ...
    public String create(
        ...
        if (name == null || name.isBlank()) {
            result = String.format(
                "redirect:/schools/%d/buildings/%d/cabinets/create?error=empty",
                school, building
            );
        } else {
            result = String.format("redirect:/schools/%d/buildings/%d/cabinets", school, building);
    ...
    public String edit(
        ...
        if (name == null || name.isBlank()) {
            result = String.format(
                "redirect:/schools/%d/buildings/%d/cabinets/%d/edit?error=empty",
                school, building, cabinet
            );
        } else {
            new SlsPostgres(this.ctx)
                .school(school)
                ...
                .renamed(name.trim());
            result = String.format(
                "redirect:/schools/%d/buildings/%d/cabinets/%d",
                school, building, cabinet
            );
        }
        return result;
